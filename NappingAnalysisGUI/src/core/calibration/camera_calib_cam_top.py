...
IMAGES_DIR = BASE_DIR / "img_checker_cam_top"
IMAGES_GLOB = "*.jpg"

# Fichiers de sortie
CAMERA_JSON_PATH = CONFIG_DIR / "camera_calibration_top.json"
CAMERA_MATRIX_NPY_PATH = CONFIG_DIR / "cam_mint_top.npy"
CAMERA_DIST_NPY_PATH = CONFIG_DIR / "cam_distcoef_top.npy"
DEBUG_JSON_PATH = CONFIG_DIR / "camera_calibration_debug_top.json"

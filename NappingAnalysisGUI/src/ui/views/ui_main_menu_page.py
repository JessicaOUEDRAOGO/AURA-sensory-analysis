...
#         super().__init__(parent)
#         self.parent = parent
#         self.theme = "light"   # "dark" ou "light"
#         self.setContentsMargins(0, 0, 0, 0)
...
#             if label_titre:
#                 if self.theme == "light":
#                     label_titre.setStyleSheet("QLabel { color: rgba(15,15,15,230); }")
#                 else:
...
#         self.pushButton_Settings = content.findChild(QtWidgets.QPushButton, "pushButton_Settings")
#         self.pushButton_Quit = content.findChild(QtWidgets.QPushButton, "pushButton_Quit")
#         # --- THEME : pas dans le .ui -> on le crée ---
#         self.pushButton_Theme = QtWidgets.QPushButton("Theme")
...
#         self.pushButton_Record.setText("Start Session")
#         self.pushButton_Theme.setText("Light / Dark")
#         self.pushButton_2_ARS.setText("Augmented Reality")
#         self.pushButton_background.setText("Projection Background")
#         self.pushButton_Settings.setText("System Settings")
#         self.pushButton_Quit.setText("Exit")
...
#                 color: rgba(255, 255, 255, 235);
#                 background-color: rgba(255, 214, 120, 18);
#                 border: 1px solid rgba(255, 214, 120, 80);
#                 border-radius: 18px;
#                 padding: 18px 22px;
#                 font-size: 16px;
#                 font-weight: 600;
...
#             QPushButton {
#                 color: rgba(255,255,255,235);
#                 background-color: rgba(255,214,120,20);
#                 border: 1px solid rgba(255,214,120,80);
#                 border-radius: 18px;
#                 padding: 18px 22px;
#                 font-size: 16px;
...
#             }
#             QPushButton:hover {
#                 border: 1px solid rgba(255,214,120,160);
#             }
#             """
